...
class Ability:
    ...
    effects = [
        ...
        {'value': 0.31, 'text': 'Give a random minion in your hand <ability>'},
        {'value': 0.31, 'text': 'Give a random minion in your hand "<ability_aura>"'},
        {'value': 0.31, 'text': 'Give a random minion in your hand <stackable_effect>'},
        ...
        {'value': 0.42, 'text': 'Summon a <v+(1-10)>/<v+(1-10)> minion with <ability>'},
        {'value': 0.42, 'text': 'Summon a <v+(1-10)>/<v+(1-10)> minion with "<ability_aura>"'},
        {'value': 0.46, 'text': 'Summon a <v+(1-10)>/<v+(1-10)> <minion_type>'},
        {'value': 0.44, 'text': 'Summon a <v+(1-10)>/<v+(1-10)> <minion_type> with <ability>'},
        {'value': 0.44, 'text': 'Summon a <v+(1-10)>/<v+(1-10)> <minion_type> with "<ability_aura>"'},
        {'value': 5.00, 'text': 'Fill your hand with random <minion_type>s'},
        {'value': 4.50, 'text': 'Fill your hand with random <card_type>s'},
        {'value': 0.21, 'text': "Destroy your opponent's weapon"},
    ]

    targetable_effects = [
        {'value': 0.82, 'text': 'Deal <v+(0-8)> damage to a minion'},
        {'value': 0.82, 'text': 'Deal <v+(1-6)> damage to an enemy character'},
        {'value': 0.82, 'text': 'Deal <v+(1-10)> damage'},
...
class MinionAbility(Ability):
    templates = Ability.templates + [
        ...
        {'value': 0.50, 'text': 'Your other minions have <stackable_effect>.'},
        {'value': 0.50, 'text': 'Your other minions have <ability>.'},
        {'value': 0.62, 'text': 'Your minions have <stackable_effect>.'},
        {'value': 0.62, 'text': 'Your minions have <ability>.'},
...
class SpellAbility(Ability):
    templates = [
        ...
        {'value': 0.50, 'text': 'Until your next turn, whenever <trigger>, <effect>.'},
        {'value': 0.20, 'text': 'Combo: <effect>.', 'restrict':['rogue']},
        {'value': 0.20, 'text': 'Combo: <targetable_effect>.', 'restrict':['rogue']},
        {'value': 1.00, 'text': 'Costs (<v+(1-4)>) less for each <minion_type> you control.'},
    ]
